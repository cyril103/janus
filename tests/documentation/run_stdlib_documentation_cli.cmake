...
if(NOT MODULE_COUNT EQUAL 42)
    message(FATAL_ERROR "expected 42 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1261)
    message(FATAL_ERROR "expected 1261 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
