...
if(NOT MODULE_COUNT EQUAL 37)
    message(FATAL_ERROR "expected 37 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1209)
    message(FATAL_ERROR "expected 1209 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
