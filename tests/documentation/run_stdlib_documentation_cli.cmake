...
if(NOT MODULE_COUNT EQUAL 41)
    message(FATAL_ERROR "expected 41 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1260)
    message(FATAL_ERROR "expected 1260 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
