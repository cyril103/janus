...
if(NOT MODULE_COUNT EQUAL 32)
    message(FATAL_ERROR "expected 32 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1005)
    message(FATAL_ERROR "expected 1005 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
