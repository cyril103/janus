...
if(NOT MODULE_COUNT EQUAL 38)
    message(FATAL_ERROR "expected 38 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1215)
    message(FATAL_ERROR "expected 1215 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
