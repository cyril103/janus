...
if(NOT MODULE_COUNT EQUAL 45)
    message(FATAL_ERROR "expected 45 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1457)
    message(FATAL_ERROR "expected 1457 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
