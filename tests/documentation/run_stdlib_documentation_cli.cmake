...
if(NOT MODULE_COUNT EQUAL 36)
    message(FATAL_ERROR "expected 36 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1099)
    message(FATAL_ERROR "expected 1099 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
