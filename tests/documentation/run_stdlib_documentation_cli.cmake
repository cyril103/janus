...
if(NOT MODULE_COUNT EQUAL 43)
    message(FATAL_ERROR "expected 43 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1420)
    message(FATAL_ERROR "expected 1420 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
