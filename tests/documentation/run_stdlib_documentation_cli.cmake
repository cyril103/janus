...
if(NOT MODULE_COUNT EQUAL 40)
    message(FATAL_ERROR "expected 40 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1251)
    message(FATAL_ERROR "expected 1251 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
