...
if(NOT MODULE_COUNT EQUAL 35)
    message(FATAL_ERROR "expected 35 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1073)
    message(FATAL_ERROR "expected 1073 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
