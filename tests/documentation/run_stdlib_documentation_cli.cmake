...
if(NOT MODULE_COUNT EQUAL 33)
    message(FATAL_ERROR "expected 33 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1028)
    message(FATAL_ERROR "expected 1028 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
