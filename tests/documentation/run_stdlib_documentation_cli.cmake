...
if(NOT MODULE_COUNT EQUAL 29)
    message(FATAL_ERROR "expected 29 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 922)
    message(FATAL_ERROR "expected 922 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
