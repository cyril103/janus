...
if(NOT MODULE_COUNT EQUAL 39)
    message(FATAL_ERROR "expected 39 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1229)
    message(FATAL_ERROR "expected 1229 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
