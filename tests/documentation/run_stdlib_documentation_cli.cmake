...
if(NOT MODULE_COUNT EQUAL 31)
    message(FATAL_ERROR "expected 31 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 978)
    message(FATAL_ERROR "expected 978 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
