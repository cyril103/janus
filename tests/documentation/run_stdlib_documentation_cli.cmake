...
if(NOT MODULE_COUNT EQUAL 34)
    message(FATAL_ERROR "expected 34 documented stdlib modules, got ${MODULE_COUNT}")
endif()
string(REGEX MATCHALL "\"signature\":\"[^\"]*\"" SYMBOLS "${INDEX_CONTENT}")
list(LENGTH SYMBOLS SYMBOL_COUNT)
if(NOT SYMBOL_COUNT EQUAL 1060)
    message(FATAL_ERROR "expected 1060 documented stdlib symbols, got ${SYMBOL_COUNT}")
endif()
