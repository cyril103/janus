...
enum class DiagnosticCode {
  ...
  ParserInvalidUnicodeEscape,
  ParserSyntaxDepthExceeded,
  ModuleLegacy,
  AnalyzerLegacy,
  ...
  AnalyzerIncompatibleCallCapability,
  AnalyzerConsumedCallback,
  AnalyzerExclusiveCallback,
  AnalyzerAffineCallbackLoop,
  AnalyzerFunctionResolution,
  AnalyzerReturnInference,
...
diagnostic_code_name(DiagnosticCode code) noexcept {
  ...
  case DiagnosticCode::AnalyzerFunctionResolution:
    return "JANA0041";
  case DiagnosticCode::AnalyzerReturnInference:
    return "JANA0050";
