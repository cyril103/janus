...
- **31 modules**, **10822 lignes** et **978 symboles publics** inventoriés ;
- **986 blocs `///` publics pour 978 symboles** (couverture source du lot #115 : 100 %) ;
- **169 sites d'allocation**, **236 marqueurs de nettoyage**, **208/14/41** occurrences `move`/`consume`/destructeur ;
- **23/31 modules** importés directement par au moins une fixture ou un test, soit **124 couples module-fichier de test** ;
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | ---: | ---: | --- | ---: | --- |
| `std.array` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 28 | 674 | 28 | 18/1/3 | 0/6/10 | 14 | 27 | `std.iterator`, `std.option` | 38 | `docs/language-guide.md` |
...
| `std.iterator` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 18 | 437 | 18 | 38/8/7 | 0/27/0 | 14 | 32 | `std.builder`, `std.option` | 2 | `docs/language-guide.md`, `docs/stability-contract.md` |
