...
- **23/31 modules** importés directement par au moins une fixture ou un test, soit **123 couples module-fichier de test** ;
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | ---: | ---: | --- | ---: | --- |
| `std.array` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 28 | 674 | 28 | 18/1/3 | 0/6/10 | 14 | 27 | `std.iterator`, `std.option` | 37 | `docs/language-guide.md` |
