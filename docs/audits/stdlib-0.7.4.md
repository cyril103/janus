...
- **36 modules**, **12544 lignes** et **1099 symboles publics** inventoriés ;
- **1107 blocs `///` publics pour 1099 symboles** (couverture source du lot #115 : 100 %) ;
- **187 sites d'allocation**, **336 marqueurs de nettoyage**, **204/23/46** occurrences `move`/`consume`/destructeur ;
- **30/36 modules** importés directement par au moins une fixture ou un test, soit **199 couples module-fichier de test** ;
...
| `std.option` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 10 | 153 | 10 | 16/0/1 | 0/24/0 | 2 | 13 | — | 14 | `docs/language-guide.md`, `docs/stability-contract.md` |
...
| `std.result` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 14 | 214 | 14 | 28/0/1 | 20/10/0 | 2 | 21 | `std.option` | 17 | `docs/language-guide.md`, `docs/stability-contract.md` |
