...
- **40 modules**, **15105 lignes** et **1197 symboles publics** inventoriés ;
- **1261 blocs `///` publics pour 1197 symboles** (couverture source du lot #115 : 100 %) ;
- **246 sites d'allocation**, **556 marqueurs de nettoyage**, **490/69/61** occurrences `move`/`consume`/destructeur ;
- **35/40 modules** importés directement par au moins une fixture ou un test, soit **258 couples module-fichier de test** ;
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | ---: | ---: | --- | ---: | --- |
| `std.array` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 39 | 893 | 39 | 26/2/3 | 2/6/15 | 14 | 54 | `std.error`, `std.iterator`, `std.option`, `std.ordering`, `std.result` | 71 | `docs/language-guide.md` |
...
| `std.validated` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 20 | 476 | 31 | 61/7/1 | 3/7/2 | 13 | 31 | `std.array`, `std.iterator`, `std.option`, `std.result` | 3 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/validated.md` |
...
| `std.validated` | `tests/fixtures/runtime/owned_validated.janus`, `tests/fixtures/runtime/testing_assertions.janus`, `tests/fixtures/runtime/validated.janus` |
