...
- **42 modules**, **15190 lignes** et **1206 symboles publics** inventoriés ;
- **1275 blocs `///` publics pour 1206 symboles** (couverture source du lot #115 : 100 %) ;
- **248 sites d'allocation**, **560 marqueurs de nettoyage**, **493/96/62** occurrences `move`/`consume`/destructeur ;
- **37/42 modules** importés directement par au moins une fixture ou un test, soit **268 couples module-fichier de test** ;
...
| `std.functional` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) | 6 | 81 | 6 | 7/0/0 | 0/0/0 | 0 | 13 | — | 2 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/functional-pipeline.md` |
...
| `std.option` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 23 | 571 | 45 | 61/12/2 | 0/72/1 | 9 | 39 | — | 28 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/option-result-combinators.md`, `docs/stability-contract.md` |
...
| `std.functional` | `tests/fixtures/runtime/functional_pipeline.janus`, `tests/fixtures/runtime/stdlib_pure_contracts.janus` |
