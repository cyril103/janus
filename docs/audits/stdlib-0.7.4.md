...
- **45 modules**, **18313 lignes** et **1267 symboles publics** inventoriés ;
- **1474 blocs `///` publics pour 1267 symboles** (couverture source du lot #115 : 100 %) ;
- **382 sites d'allocation**, **1043 marqueurs de nettoyage**, **1267/101/74** occurrences `move`/`consume`/destructeur ;
- **40/45 modules** importés directement par au moins une fixture ou un test, soit **347 couples module-fichier de test** ;
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | ---: | ---: | --- | ---: | --- |
| `std.array` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 39 | 893 | 40 | 26/4/3 | 2/6/15 | 14 | 54 | `std.error`, `std.index`, `std.iterator`, `std.option`, `std.ordering`, `std.result` | 82 | `docs/language-guide.md` |
| `std.array_builder` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 9 | 153 | 9 | 16/0/1 | 4/3/2 | 6 | 10 | `std.array`, `std.builder`, `std.iterator`, `std.option`, `std.result` | 7 | `docs/language-guide.md`, `docs/design/iterator-pipelines.md` |
...
| `std.bytes` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 8 | 92 | 8 | 1/0/0 | 0/1/2 | 1 | 5 | `std.option` | 10 | `docs/language-guide.md`, `docs/stdlib-reference.md` |
...
| `std.deque` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 35 | 478 | 35 | 21/6/4 | 7/26/5 | 8 | 20 | `std.array`, `std.error`, `std.iterator`, `std.option`, `std.result` | 3 | `docs/language-guide.md`, `docs/stdlib-reference.md` |
| `std.error` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 6 | 18 | 6 | 0/0/0 | 0/0/0 | 0 | 0 | — | 3 | `docs/language-guide.md`, `docs/stdlib-reference.md` |
...
| `std.graphics.drawing` | `experimental` | `conservation` | [#114 / R074-5](https://github.com/cyril103/janus/issues/114) | 106 | 1252 | 106 | 0/0/0 | 0/0/0 | 0 | 0 | `std.c`, `std.graphics.types`, `std.time` | 1 | `docs/graphics.md` |
...
| `std.fs` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) | 26 | 505 | 26 | 1/0/2 | 13/5/3 | 12 | 26 | `std.bytes`, `std.io`, `std.option`, `std.path`, `std.result`, `std.system` | 3 | `docs/language-guide.md`, `docs/design/path-filesystem.md`, `docs/stability-contract.md` |
| `std.functional` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) | 9 | 2168 | 147 | 701/0/0 | 0/0/0 | 60 | 301 | `std.option.` | 7 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/functional-pipeline.md` |
| `std.hash_probe` | `internal-detail` | `refonte-interne` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) | 6 | 83 | 6 | 0/0/0 | 0/0/0 | 1 | 0 | — | 1 | `docs/public-surface-0.5.json` |
| `std.hashing` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) | 24 | 179 | 24 | 0/0/0 | 0/0/0 | 1 | 0 | — | 26 | `docs/language-guide.md`, `docs/stability-contract.md` |
| `std.hashmap` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) | 30 | 929 | 34 | 43/9/3 | 3/26/4 | 14 | 26 | `std.array`, `std.builder`, `std.error`, `std.hash_probe`, `std.hashing`, `std.iterator`, `std.option`, `std.result` | 25 | `docs/language-guide.md`, `docs/stability-contract.md` |
| `std.hashset` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) | 22 | 623 | 26 | 19/4/3 | 3/10/2 | 10 | 18 | `std.array`, `std.builder`, `std.error`, `std.hash_probe`, `std.hashing`, `std.iterator`, `std.option`, `std.result` | 7 | `docs/language-guide.md`, `docs/stability-contract.md` |
| `std.io` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) | 35 | 920 | 35 | 9/0/4 | 22/14/0 | 18 | 33 | `std.bytes`, `std.error`, `std.option`, `std.result`, `std.system` | 10 | `docs/language-guide.md`, `docs/design/io-streams.md`, `docs/stability-contract.md` |
| `std.index` | `experimental` | `conservation` | [#336](https://github.com/cyril103/janus/issues/336) | 4 | 31 | 6 | 0/0/0 | 0/0/0 | 0 | 0 | — | 2 | `docs/stdlib-reference.md`, `website/docs/book/06-collections-iterateurs.md` |
| `std.iterator` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 37 | 927 | 37 | 89/35/14 | 4/53/2 | 29 | 92 | `std.builder`, `std.option`, `std.result` | 15 | `docs/language-guide.md`, `docs/design/iterator-pipelines.md`, `docs/stability-contract.md` |
| `std.math` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) | 104 | 546 | 104 | 1/0/0 | 0/0/1 | 1 | 0 | `std.array` | 7 | `docs/language-guide.md`, `docs/stability-contract.md` |
...
| `std.option` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 23 | 571 | 45 | 61/12/2 | 0/72/1 | 9 | 39 | — | 33 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/option-result-combinators.md`, `docs/stability-contract.md` |
...
| `std.persistent_list` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) | 18 | 389 | 18 | 38/1/4 | 0/14/1 | 13 | 49 | `std.array`, `std.iterator`, `std.option`, `std.shared` | 3 | `docs/stdlib-reference.md`, `docs/design/persistent-list.md` |
| `std.persistent_map` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) | 37 | 576 | 37 | 52/3/9 | 0/15/1 | 46 | 120 | `std.array`, `std.array_builder`, `std.hashmap`, `std.iterator`, `std.option`, `std.shared` | 2 | `docs/stdlib-reference.md`, `docs/design/persistent-map.md` |
| `std.persistent_set` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) | 0 | 3 | 0 | 0/0/0 | 0/0/0 | 0 | 0 | `std.persistent_map` | 1 | `docs/stdlib-reference.md`, `docs/design/persistent-map.md` |
| `std.persistent_vector` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) | 18 | 412 | 18 | 26/2/3 | 0/4/6 | 30 | 75 | `std.array`, `std.array_builder`, `std.iterator`, `std.option`, `std.shared` | 8 | `docs/stdlib-reference.md`, `docs/language-guide.md`, `docs/design/persistent-vector.md` |
| `std.priority_queue` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 15 | 266 | 15 | 4/0/1 | 2/2/5 | 3 | 7 | `std.array`, `std.error`, `std.option`, `std.result` | 4 | `docs/language-guide.md`, `docs/stdlib-reference.md` |
...
| `std.process` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) | 28 | 588 | 28 | 2/0/4 | 12/10/0 | 16 | 18 | `std.array`, `std.bytes`, `std.option`, `std.result`, `std.system` | 2 | `docs/language-guide.md`, `docs/design/process-runtime.md`, `docs/stability-contract.md` |
| `std.range` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 1 | 44 | 1 | 0/1/0 | 0/1/0 | 2 | 1 | `std.iterator`, `std.option` | 3 | `docs/language-guide.md` |
| `std.result` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 26 | 664 | 49 | 89/14/2 | 80/22/2 | 7 | 44 | `std.option` | 26 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/option-result-combinators.md`, `docs/stability-contract.md` |
| `std.shared` | `experimental` | `conservation` | [#299](https://github.com/cyril103/janus/issues/299) | 7 | 122 | 7 | 1/0/1 | 0/0/3 | 4 | 7 | — | 15 | `docs/design/shared-immutable.md` |
| `std.slice` | `experimental` | `conservation` | [#264](https://github.com/cyril103/janus/issues/264) | 16 | 220 | 18 | 1/2/0 | 0/6/7 | 4 | 2 | `std.array`, `std.index`, `std.iterator`, `std.option` | 5 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/stability-contract.md` |
...
| `std.unicode` | `experimental` | `conservation` | [#351](https://github.com/cyril103/janus/issues/351) | 1 | 30 | 1 | 0/0/0 | 0/3/0 | 0 | 0 | `std.option` | 1 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/text.md` |
...
| --- | --- |
| `std.array` | `tests/compatibility/stdlib.janus`, `tests/diagnostics/invalid/array-literal-empty-inference.janus`, `tests/diagnostics/invalid/array-literal-global-constant.janus`, `tests/diagnostics/invalid/array-literal-incompatible-element.janus`, `tests/diagnostics/invalid/array-literal-owned-element-move.janus`, `tests/diagnostics/invalid/iterator-hidden-borrow-adapter.janus`, `tests/diagnostics/invalid/iterator-hidden-borrow-delete.janus`, `tests/diagnostics/invalid/validated-errors-constructor-internal.janus`, `tests/diagnostics/invalid/validated-invalid-array-migration.janus`, `tests/fixtures/iterator_hidden_borrow_release.janus`, `tests/fixtures/project-euler/production/problem11.janus`, `tests/fixtures/project-euler/production/problem13.janus`, `tests/fixtures/project-euler/production/problem16.janus`, `tests/fixtures/project-euler/production/problem18.janus`, `tests/fixtures/project-euler/production/problem20.janus`, `tests/fixtures/project-euler/production/problem8.janus`, `tests/fixtures/runtime/array_factories.janus`, `tests/fixtures/runtime/array_factory_capacity_overflow.janus`, `tests/fixtures/runtime/array_factory_panic_cleanup.janus`, `tests/fixtures/runtime/array_literal_panic_cleanup.janus`, `tests/fixtures/runtime/array_literals.janus`, `tests/fixtures/runtime/array_out_of_bounds.janus`, `tests/fixtures/runtime/array_sort.janus`, `tests/fixtures/runtime/borrow_panic_cleanup.janus`, `tests/fixtures/runtime/borrowed_closure.janus`, `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/contextual_constructor_inference.janus`, `tests/fixtures/runtime/contextual_lambda_parameters.janus`, `tests/fixtures/runtime/filled_array_non_copy_error.janus`, `tests/fixtures/runtime/functional_sequence_cleanup.janus`, `tests/fixtures/runtime/indexing.janus`, `tests/fixtures/runtime/indexing_borrow_conflict_error.janus`, `tests/fixtures/runtime/indexing_const_purity_error.janus`, `tests/fixtures/runtime/indexing_global_dependencies.janus`, `tests/fixtures/runtime/indexing_immutable_error.janus`, `tests/fixtures/runtime/indexing_member_move_error.janus`, `tests/fixtures/runtime/indexing_move_error.janus`, `tests/fixtures/runtime/indexing_non_copy_error.janus`, `tests/fixtures/runtime/indexing_out_of_bounds.janus`, `tests/fixtures/runtime/indexing_read_borrow_conflict_error.janus`, `tests/fixtures/runtime/indexing_shared_chain_compound_error.janus`, `tests/fixtures/runtime/indexing_shared_chain_error.janus`, `tests/fixtures/runtime/indexing_shared_member_compound_error.janus`, `tests/fixtures/runtime/indexing_shared_member_error.janus`, `tests/fixtures/runtime/indexing_shared_return_error.janus`, `tests/fixtures/runtime/iterator_extended.janus`, `tests/fixtures/runtime/lambda_block_body.janus`, `tests/fixtures/runtime/mutable_borrow.janus`, `tests/fixtures/runtime/owned_array.janus`, `tests/fixtures/runtime/owned_array_copy_error.janus`, `tests/fixtures/runtime/owned_array_move_error.janus`, `tests/fixtures/runtime/owned_array_panic.janus`, `tests/fixtures/runtime/owned_array_sort_error.janus`, `tests/fixtures/runtime/owned_iterator_borrow_error.janus`, `tests/fixtures/runtime/owned_iterator_extended.janus`, `tests/fixtures/runtime/owned_iterator_for_copy_error.janus`, `tests/fixtures/runtime/owned_iterator_panic.janus`, `tests/fixtures/runtime/owned_iterators.janus`, `tests/fixtures/runtime/owned_validated.janus`, `tests/fixtures/runtime/persistent_list.janus`, `tests/fixtures/runtime/persistent_list_deep_destruction.janus`, `tests/fixtures/runtime/persistent_list_panic_cleanup.janus`, `tests/fixtures/runtime/persistent_map.janus`, `tests/fixtures/runtime/persistent_vector.janus`, `tests/fixtures/runtime/persistent_vector_allocation_panic.janus`, `tests/fixtures/runtime/persistent_vector_deep_destruction.janus`, `tests/fixtures/runtime/persistent_vector_filter_panic.janus`, `tests/fixtures/runtime/persistent_vector_get_panic.janus`, `tests/fixtures/runtime/persistent_vector_map_panic.janus`, `tests/fixtures/runtime/persistent_vector_pop_panic.janus`, `tests/fixtures/runtime/persistent_vector_set_panic.janus`, `tests/fixtures/runtime/prime_factors.janus`, `tests/fixtures/runtime/priority_queue.janus`, `tests/fixtures/runtime/processes.janus`, `tests/fixtures/runtime/sequence_pipeline_stress.janus`, `tests/fixtures/runtime/slice_out_of_bounds.janus`, `tests/fixtures/runtime/slices.janus`, `tests/fixtures/runtime/stdlib_pure_contracts.janus`, `tests/fixtures/runtime/validated.janus`, `tests/frontend/parser_top_level_declaration_test.cpp`, `tests/language/indexing_test.cpp` |
| `std.array_builder` | `tests/compatibility/stdlib.janus`, `tests/fixtures/runtime/functional_sequence_cleanup.janus`, `tests/fixtures/runtime/iterator_extended.janus`, `tests/fixtures/runtime/owned_hash_collections.janus`, `tests/fixtures/runtime/owned_iterator_extended.janus`, `tests/fixtures/runtime/owned_iterators.janus`, `tests/fixtures/runtime/persistent_vector.janus` |
| `std.builder` | aucune |
| `std.bytes` | `tests/fixtures/runtime/assert_bytes_size_failure.janus`, `tests/fixtures/runtime/assert_bytes_value_failure.janus`, `tests/fixtures/runtime/byte_view_get_out_of_bounds.janus`, `tests/fixtures/runtime/byte_view_slice_out_of_bounds.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/internal_constructor_error.janus`, `tests/fixtures/runtime/nested_byte_views.janus`, `tests/fixtures/runtime/path_fs_result.janus`, `tests/fixtures/runtime/processes.janus`, `tests/fixtures/runtime/testing_assertions.janus` |
| `std.c` | `tests/fixtures/runtime/text_api.janus`, `tests/interop/c_abi.janus` |
| `std.deque` | `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/deque_queue.janus` |
| `std.error` | `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/priority_queue.janus` |
...
| `std.graphics.drawing` | `tests/fixtures/runtime/borrowed_native_return_free_error.janus` |
...
| `std.functional` | `tests/fixtures/runtime/functional_factories.janus`, `tests/fixtures/runtime/functional_factories_panic_inner.janus`, `tests/fixtures/runtime/functional_factories_panic_outer.janus`, `tests/fixtures/runtime/functional_factories_panic_uncurried_first.janus`, `tests/fixtures/runtime/functional_factories_panic_uncurried_second.janus`, `tests/fixtures/runtime/functional_pipeline.janus`, `tests/fixtures/runtime/stdlib_pure_contracts.janus` |
| `std.hash_probe` | `tests/fixtures/runtime/stdlib_pure_contracts.janus` |
| `std.hashing` | `tests/diagnostics/invalid/map-literal-constant-duplicate.janus`, `tests/diagnostics/invalid/map-literal-double-move.janus`, `tests/diagnostics/invalid/map-literal-empty-context.janus`, `tests/diagnostics/invalid/map-literal-global-constant.janus`, `tests/diagnostics/invalid/map-literal-homonym.janus`, `tests/diagnostics/invalid/map-literal-incompatible-value.janus`, `tests/diagnostics/invalid/map-literal-local-constant-duplicate.janus`, `tests/diagnostics/invalid/map-literal-no-context.janus`, `tests/diagnostics/invalid/map-literal-owned-move.janus`, `tests/diagnostics/invalid/map-literal-stateful-strategy.janus`, `tests/diagnostics/invalid/map-literal-string-duplicate.janus`, `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/derived_capabilities.janus`, `tests/fixtures/runtime/hash_table_invariants.janus`, `tests/fixtures/runtime/hashing_borrow_error.janus`, `tests/fixtures/runtime/map_literal_allocations.janus`, `tests/fixtures/runtime/map_literal_duplicate.janus`, `tests/fixtures/runtime/map_literal_equality_panic.janus`, `tests/fixtures/runtime/map_literal_hash_panic.janus`, `tests/fixtures/runtime/map_literal_panic_cleanup.janus`, `tests/fixtures/runtime/owned_hash_collections.janus`, `tests/fixtures/runtime/owned_hash_copy_error.janus`, `tests/fixtures/runtime/owned_hash_move_error.janus`, `tests/fixtures/runtime/owned_hash_panic.janus`, `tests/fixtures/runtime/owned_iterators.janus` |
| `std.hashmap` | `tests/diagnostics/invalid/map-literal-constant-duplicate.janus`, `tests/diagnostics/invalid/map-literal-double-move.janus`, `tests/diagnostics/invalid/map-literal-empty-context.janus`, `tests/diagnostics/invalid/map-literal-global-constant.janus`, `tests/diagnostics/invalid/map-literal-incompatible-value.janus`, `tests/diagnostics/invalid/map-literal-local-constant-duplicate.janus`, `tests/diagnostics/invalid/map-literal-no-context.janus`, `tests/diagnostics/invalid/map-literal-owned-move.janus`, `tests/diagnostics/invalid/map-literal-stateful-strategy.janus`, `tests/diagnostics/invalid/map-literal-string-duplicate.janus`, `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/derived_capabilities.janus`, `tests/fixtures/runtime/hash_table_invariants.janus`, `tests/fixtures/runtime/map_literal_allocations.janus`, `tests/fixtures/runtime/map_literal_duplicate.janus`, `tests/fixtures/runtime/map_literal_equality_panic.janus`, `tests/fixtures/runtime/map_literal_hash_panic.janus`, `tests/fixtures/runtime/map_literal_panic_cleanup.janus`, `tests/fixtures/runtime/owned_hash_collections.janus`, `tests/fixtures/runtime/owned_hash_copy_error.janus`, `tests/fixtures/runtime/owned_hash_panic.janus`, `tests/fixtures/runtime/owned_iterators.janus`, `tests/fixtures/runtime/persistent_map.janus`, `tests/fixtures/runtime/persistent_map_allocation_panic.janus` |
| `std.hashset` | `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/derived_capabilities.janus`, `tests/fixtures/runtime/hash_table_invariants.janus`, `tests/fixtures/runtime/owned_hash_collections.janus`, `tests/fixtures/runtime/owned_hash_move_error.janus`, `tests/fixtures/runtime/owned_iterators.janus` |
| `std.io` | `tests/fixtures/runtime/assert_bytes_size_failure.janus`, `tests/fixtures/runtime/assert_bytes_value_failure.janus`, `tests/fixtures/runtime/byte_view_get_out_of_bounds.janus`, `tests/fixtures/runtime/byte_view_slice_out_of_bounds.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/io_streams.janus`, `tests/fixtures/runtime/mutable_borrow.janus`, `tests/fixtures/runtime/nested_byte_views.janus`, `tests/fixtures/runtime/processes.janus`, `tests/fixtures/runtime/testing_assertions.janus` |
| `std.index` | `tests/fixtures/runtime/indexing.janus`, `tests/language/indexing_test.cpp` |
| `std.iterator` | `tests/diagnostics/invalid/iterator-hidden-borrow-adapter.janus`, `tests/diagnostics/invalid/iterator-hidden-borrow-delete.janus`, `tests/fixtures/iterator_hidden_borrow_release.janus`, `tests/fixtures/runtime/iterator_extended.janus`, `tests/fixtures/runtime/owned_iterator_borrow_error.janus`, `tests/fixtures/runtime/owned_iterator_extended.janus`, `tests/fixtures/runtime/owned_iterator_panic.janus`, `tests/fixtures/runtime/owned_validated.janus`, `tests/fixtures/runtime/persistent_map.janus`, `tests/fixtures/runtime/persistent_map_allocation_panic.janus`, `tests/fixtures/runtime/persistent_map_deep_destruction.janus`, `tests/fixtures/runtime/persistent_vector.janus`, `tests/fixtures/runtime/persistent_vector_allocation_panic.janus`, `tests/fixtures/runtime/sequence_pipeline_stress.janus`, `tests/fixtures/runtime/validated.janus` |
| `std.math` | `tests/compatibility/stdlib.janus`, `tests/fixtures/runtime/floating_math.janus`, `tests/fixtures/runtime/lcm_overflow.janus`, `tests/fixtures/runtime/lcm_overflow_reversed.janus`, `tests/fixtures/runtime/math_helpers.janus`, `tests/fixtures/runtime/prime_factors.janus`, `tests/fixtures/runtime/stdlib_pure_contracts.janus` |
...
| `std.option` | `tests/compatibility/stdlib.janus`, `tests/fixtures/runtime/assert_where_failure.janus`, `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/checked_char.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/functional_factories.janus`, `tests/fixtures/runtime/functional_pipeline.janus`, `tests/fixtures/runtime/functional_sequence_cleanup.janus`, `tests/fixtures/runtime/iterator_extended.janus`, `tests/fixtures/runtime/map_literals.janus`, `tests/fixtures/runtime/option_combinators.janus`, `tests/fixtures/runtime/option_contains_closure_error.janus`, `tests/fixtures/runtime/option_contains_equality.janus`, `tests/fixtures/runtime/option_contains_plain_type_error.janus`, `tests/fixtures/runtime/option_contains_pointer_error.janus`, `tests/fixtures/runtime/option_result_laws.janus`, `tests/fixtures/runtime/owned_iterator_extended.janus`, `tests/fixtures/runtime/owned_iterators.janus`, `tests/fixtures/runtime/owned_option_combinators.janus`, `tests/fixtures/runtime/owned_option_move_error.janus`, `tests/fixtures/runtime/owned_option_observe_temporary_error.janus`, `tests/fixtures/runtime/owned_option_result_laws.janus`, `tests/fixtures/runtime/owned_result_combinators.janus`, `tests/fixtures/runtime/persistent_map.janus`, `tests/fixtures/runtime/persistent_map_allocation_panic.janus`, `tests/fixtures/runtime/persistent_vector.janus`, `tests/fixtures/runtime/priority_queue.janus`, `tests/fixtures/runtime/processes.janus`, `tests/fixtures/runtime/shared_deep_destruction.janus`, `tests/fixtures/runtime/stdlib_extension_methods.janus`, `tests/fixtures/runtime/stdlib_pure_contracts.janus`, `tests/fixtures/runtime/testing_assertions.janus`, `tests/fixtures/runtime/validated.janus` |
...
| `std.persistent_list` | `tests/fixtures/runtime/persistent_list.janus`, `tests/fixtures/runtime/persistent_list_deep_destruction.janus`, `tests/fixtures/runtime/persistent_list_panic_cleanup.janus` |
| `std.persistent_map` | `tests/fixtures/runtime/persistent_map_allocation_panic.janus`, `tests/fixtures/runtime/persistent_map_deep_destruction.janus` |
| `std.persistent_set` | `tests/fixtures/runtime/persistent_map.janus` |
| `std.persistent_vector` | `tests/fixtures/runtime/persistent_vector.janus`, `tests/fixtures/runtime/persistent_vector_allocation_panic.janus`, `tests/fixtures/runtime/persistent_vector_deep_destruction.janus`, `tests/fixtures/runtime/persistent_vector_filter_panic.janus`, `tests/fixtures/runtime/persistent_vector_get_panic.janus`, `tests/fixtures/runtime/persistent_vector_map_panic.janus`, `tests/fixtures/runtime/persistent_vector_pop_panic.janus`, `tests/fixtures/runtime/persistent_vector_set_panic.janus` |
| `std.priority_queue` | `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/owned_priority_queue_move_error.janus`, `tests/fixtures/runtime/priority_queue.janus` |
...
| `std.result` | `tests/compatibility/stdlib.janus`, `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/functional_sequence_cleanup.janus`, `tests/fixtures/runtime/iterator_extended.janus`, `tests/fixtures/runtime/numeric_conversion_matrix.janus`, `tests/fixtures/runtime/numeric_conversions.janus`, `tests/fixtures/runtime/numeric_conversions_aliased_imports.janus`, `tests/fixtures/runtime/option_result_laws.janus`, `tests/fixtures/runtime/owned_iterator_extended.janus`, `tests/fixtures/runtime/owned_iterator_panic.janus`, `tests/fixtures/runtime/owned_option_result_laws.janus`, `tests/fixtures/runtime/owned_result_combinators.janus`, `tests/fixtures/runtime/owned_result_move_error.janus`, `tests/fixtures/runtime/owned_result_observe_temporary_error.janus`, `tests/fixtures/runtime/owned_result_try.janus`, `tests/fixtures/runtime/owned_result_try_move_error.janus`, `tests/fixtures/runtime/owned_result_try_reuse_error.janus`, `tests/fixtures/runtime/owned_validated.janus`, `tests/fixtures/runtime/priority_queue.janus`, `tests/fixtures/runtime/result_combinators.janus`, `tests/fixtures/runtime/stdlib_extension_methods.janus`, `tests/fixtures/runtime/stdlib_pure_contracts.janus`, `tests/fixtures/runtime/testing_assertions.janus`, `tests/fixtures/runtime/text_api.janus`, `tests/fixtures/runtime/validated.janus` |
| `std.shared` | `tests/fixtures/runtime/persistent_list.janus`, `tests/fixtures/runtime/persistent_map.janus`, `tests/fixtures/runtime/persistent_map_allocation_panic.janus`, `tests/fixtures/runtime/persistent_map_deep_destruction.janus`, `tests/fixtures/runtime/persistent_vector.janus`, `tests/fixtures/runtime/persistent_vector_allocation_panic.janus`, `tests/fixtures/runtime/persistent_vector_filter_panic.janus`, `tests/fixtures/runtime/persistent_vector_get_panic.janus`, `tests/fixtures/runtime/persistent_vector_map_panic.janus`, `tests/fixtures/runtime/persistent_vector_pop_panic.janus`, `tests/fixtures/runtime/persistent_vector_set_panic.janus`, `tests/fixtures/runtime/shared.janus`, `tests/fixtures/runtime/shared_deep_destruction.janus`, `tests/fixtures/runtime/shared_mutation_error.janus`, `tests/fixtures/runtime/shared_panic_cleanup.janus` |
...
| `std.unicode` | `tests/fixtures/runtime/checked_char.janus` |
...
| --- | --- | ---: |
| `pure borrow def size() : usize {` | `std.array`, `std.array_builder`, `std.deque`, `std.fs`, `std.hashmap`, `std.hashset`, `std.io`, `std.path`, `std.priority_queue`, `std.slice` | 13 |
| `index = index + usize(1)` | `std.array`, `std.hashmap`, `std.hashset`, `std.io`, `std.iterator`, `std.process`, `std.slice`, `std.testing`, `std.text` | 37 |
| `return match move value {` | `std.array_builder`, `std.iterator`, `std.option`, `std.persistent_list`, `std.persistent_vector`, `std.result`, `std.validated` | 34 |
| `var index : usize = usize(0)` | `std.array`, `std.hashmap`, `std.hashset`, `std.io`, `std.process`, `std.testing`, `std.text` | 23 |
| `consume def dispose() : Unit {` | `std.array`, `std.deque`, `std.hashmap`, `std.hashset`, `std.iterator`, `std.range`, `std.slice` | 19 |
| `pure borrow def isEmpty() : bool {` | `std.array`, `std.deque`, `std.hashmap`, `std.hashset`, `std.io`, `std.priority_queue`, `std.slice` | 8 |
| `Some(item) => move item,` | `std.array_builder`, `std.iterator`, `std.option`, `std.persistent_list`, `std.persistent_vector`, `std.result` | 7 |
| `pure borrow def capacity() : usize {` | `std.array`, `std.deque`, `std.hashmap`, `std.hashset`, `std.io`, `std.priority_queue` | 6 |
| `def next() : Option[T] {` | `std.array`, `std.deque`, `std.hashset`, `std.iterator`, `std.slice` | 15 |
| `return Result.Error[bool, CapacityError](` | `std.array`, `std.deque`, `std.hashmap`, `std.hashset`, `std.io` | 15 |
...
| `Array.getMutable` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `Array.tryPop` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `Array.tryReserve` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Array.clear` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Array.retain` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Array.extend` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Array.drain` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `Array.sortBy` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `collectResult` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `collectOption` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `ByteView` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ByteView.size` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ByteView.isEmpty` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ByteView.get` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ByteView.getOption` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ByteView.isUtf8` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ByteView.withSlice` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ByteView.withPointer` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `Deque` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.size` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.capacity` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.isEmpty` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.reserve` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.tryReserve` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.pushBack` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.pushFront` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.popFrontOption` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.popBackOption` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.tryPopFront` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.tryPopBack` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.popFront` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.popBack` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.withFront` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.withBack` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.clear` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.extend` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.drain` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Deque.intoIterator` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.size` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.capacity` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.isEmpty` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.enqueue` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.dequeue` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.dequeueOption` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.tryDequeue` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.withFirst` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.clear` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.reserve` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.tryReserve` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.extend` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.drain` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Queue.intoIterator` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |

### `std.error`

| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `CapacityError` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `CapacityError.CapacityOverflow` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `CapacityError.AllocationFailed` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `AccessError` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `AccessError.OutOfBounds` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `AccessError.Empty` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `FileData.withView` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) |
| `FileData.asText` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) |
...
| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `identity` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) |
| `constant` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) |
| `compose` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) |
| `andThen` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) |
| `partialFirst2` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) |
| `curry2` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) |
| `uncurry2` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) |
| `flip` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) |
| `tap` | `experimental` | `conservation` | [#294](https://github.com/cyril103/janus/issues/294) |
...
| `StringHashing` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `StringHashing.hash` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `StringHashing.equals` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
...
| `HashMap.capacity` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashMap.isEmpty` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashMap.reserve` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashMap.tryReserve` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
...
| `HashMap.withValue` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashMap.withEntry` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
...
| `HashMap.retain` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashMap.extend` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashMap.drainEntries` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
...
| `HashSet.capacity` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashSet.isEmpty` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashSet.reserve` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashSet.tryReserve` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashSet.contains` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashSet.withValue` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
...
| `HashSet.retain` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashSet.extend` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
| `HashSet.drain` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) |
...
| `ByteBuffer.withView` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) |
| `ByteBuffer.clear` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) |
| `ByteBuffer.tryReserve` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) |
...
| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `Index` | `experimental` | `conservation` | [#336](https://github.com/cyril103/janus/issues/336) |
| `Index.get` | `experimental` | `conservation` | [#336](https://github.com/cyril103/janus/issues/336) |
| `IndexMut` | `experimental` | `conservation` | [#336](https://github.com/cyril103/janus/issues/336) |
| `IndexMut.set` | `experimental` | `conservation` | [#336](https://github.com/cyril103/janus/issues/336) |
...
| `IntoIterable` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `IntoIterable.intoIterator` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `PartitionResult` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `PartitionResult.accepted` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `PartitionResult.rejected` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `Iterator.intoIterator` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `Iterator.drop` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.chain` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.filterMap` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.takeWhile` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.skipWhile` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.scan` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `Iterator.find` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.any` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.all` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.count` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.reduce` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.tryFold` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Iterator.partitionWith` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `Try` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `OptionPair` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `OptionPair.left` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `OptionPair.right` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `mapBorrowed` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `flatten` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `filter` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `fold` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `contains` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `zip` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `map2` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `inspect` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `unwrapOrElse` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `orElseWith` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |

### `std.ordering`

| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `Order` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Order.Less` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Order.Equal` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Order.Greater` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Ordering` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Ordering.compare` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `IntOrdering` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `IntOrdering.compare` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `USizeOrdering` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `USizeOrdering.compare` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `orderedBefore` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `PersistentList` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.size` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.isEmpty` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.clone` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.prepend` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.head` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.tail` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.iterator` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.reverse` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.concat` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.map` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.filter` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.fold` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.equalsBy` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.equals` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `PersistentList.toArray` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `persistentListEmpty` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |
| `persistentListFromArray` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) |

### `std.persistent_map`

| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `PersistentMap` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.alter` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.clone` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.containsKey` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.equals` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.equalsBy` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.filter` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.fold` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.get` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.insert` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.intoIterator` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.isEmpty` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.iterator` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.keys` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.mapValues` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.remove` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.size` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentMap.values` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.clone` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.contains` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.difference` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.equals` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.filter` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.fold` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.insert` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.intersection` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.intoIterator` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.isEmpty` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.iterator` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.remove` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.size` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `PersistentSet.union` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `persistentMapEmpty` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `persistentMapWith` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `persistentSetEmpty` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |
| `persistentSetWith` | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |

### `std.persistent_set`

| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| *(aucun symbole propre ; réexports uniquement)* | `experimental` | `conservation` | [#315](https://github.com/cyril103/janus/issues/315) |

### `std.persistent_vector`

| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `PersistentVector` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.size` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.isEmpty` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.clone` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.get` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.set` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.push` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.pop` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.iterator` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.intoIterator` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.map` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.filter` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.fold` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.equalsBy` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.equals` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `PersistentVector.toArray` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `persistentVectorEmpty` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
| `persistentVectorFromArray` | `experimental` | `conservation` | [#314](https://github.com/cyril103/janus/issues/314) |
...
| `PriorityQueue.capacity` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `PriorityQueue.isEmpty` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `PriorityQueue.reserve` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `PriorityQueue.tryReserve` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `PriorityQueue.tryDequeue` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `ProcessResult.withStdoutView` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) |
...
| `ProcessResult.withStderrView` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) |
...
| `ResultPair` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ResultPair.left` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ResultPair.right` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `mapBorrowed` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `mapErrorBorrowed` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `map` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `map2` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `inspect` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `inspectError` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `orElse` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `unwrapOr` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `unwrapOrElse` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
...
| `toResult` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `transpose` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |

### `std.shared`

| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `Shared` | `experimental` | `conservation` | [#299](https://github.com/cyril103/janus/issues/299) |
| `Shared.clone` | `experimental` | `conservation` | [#299](https://github.com/cyril103/janus/issues/299) |
| `Shared.get` | `experimental` | `conservation` | [#299](https://github.com/cyril103/janus/issues/299) |
| `Shared.strongCount` | `experimental` | `conservation` | [#299](https://github.com/cyril103/janus/issues/299) |
| `Shared.isUnique` | `experimental` | `conservation` | [#299](https://github.com/cyril103/janus/issues/299) |
| `Shared.isSame` | `experimental` | `conservation` | [#299](https://github.com/cyril103/janus/issues/299) |
| `share` | `experimental` | `conservation` | [#299](https://github.com/cyril103/janus/issues/299) |
...
| `Slice.getBorrowed` | `experimental` | `conservation` | [#264](https://github.com/cyril103/janus/issues/264) |
...
| `MutableSlice.getBorrowed` | `experimental` | `conservation` | [#264](https://github.com/cyril103/janus/issues/264) |
| `MutableSlice.getMutable` | `experimental` | `conservation` | [#264](https://github.com/cyril103/janus/issues/264) |
...
| `assertValid` | `experimental` | `conservation` | [#147](https://github.com/cyril103/janus/issues/147) |
| `assertInvalid` | `experimental` | `conservation` | [#147](https://github.com/cyril103/janus/issues/147) |
| `assertValidWhere` | `experimental` | `conservation` | [#147](https://github.com/cyril103/janus/issues/147) |
| `assertInvalidWhere` | `experimental` | `conservation` | [#147](https://github.com/cyril103/janus/issues/147) |
...
| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `checkedChar` | `experimental` | `conservation` | [#351](https://github.com/cyril103/janus/issues/351) |

### `std.validated`

| Symbole | Surface actuelle | Décision 0.7.4 | Propriétaire de migration |
| --- | --- | --- | --- |
| `Validated` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Validated.Valid` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `Validated.Invalid` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ValidatedErrors` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ValidatedErrors.inspect` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ValidatedErrors.intoArray` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ValidatedPair` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ValidatedPair.left` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `ValidatedPair.right` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `valid` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `invalid` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `invalidFromArray` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `isValid` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `isInvalid` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `map` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `mapError` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `map2` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `map3` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `zip` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `errorsBorrowed` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `intoErrors` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `fromResult` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `toResult` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
| `collectValidated` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) |
