...
- **43 modules**, **17689 lignes** et **1227 symboles publics** inventoriés ;
- **1434 blocs `///` publics pour 1227 symboles** (couverture source du lot #115 : 100 %) ;
- **338 sites d'allocation**, **923 marqueurs de nettoyage**, **1213/98/65** occurrences `move`/`consume`/destructeur ;
- **38/43 modules** importés directement par au moins une fixture ou un test, soit **301 couples module-fichier de test** ;
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | ---: | ---: | --- | ---: | --- |
| `std.array` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 39 | 893 | 40 | 26/4/3 | 2/6/15 | 14 | 54 | `std.error`, `std.index`, `std.iterator`, `std.option`, `std.ordering`, `std.result` | 81 | `docs/language-guide.md` |
...
| `std.hashmap` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) | 30 | 905 | 34 | 41/9/3 | 3/25/2 | 16 | 26 | `std.array`, `std.builder`, `std.error`, `std.hash_probe`, `std.hashing`, `std.iterator`, `std.option`, `std.result` | 8 | `docs/language-guide.md`, `docs/stability-contract.md` |
...
| `std.iterator` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 37 | 927 | 37 | 89/35/14 | 4/53/2 | 29 | 92 | `std.builder`, `std.option`, `std.result` | 12 | `docs/language-guide.md`, `docs/design/iterator-pipelines.md`, `docs/stability-contract.md` |
...
| `std.option` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 23 | 571 | 45 | 61/12/2 | 0/72/1 | 9 | 39 | — | 30 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/option-result-combinators.md`, `docs/stability-contract.md` |
...
| `std.shared` | `experimental` | `conservation` | [#299](https://github.com/cyril103/janus/issues/299) | 7 | 122 | 7 | 1/0/1 | 0/0/3 | 4 | 7 | — | 12 | `docs/design/shared-immutable.md` |
