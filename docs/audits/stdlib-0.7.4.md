...
- **40 modules**, **15098 lignes** et **1197 symboles publics** inventoriés ;
- **1261 blocs `///` publics pour 1197 symboles** (couverture source du lot #115 : 100 %) ;
- **246 sites d'allocation**, **556 marqueurs de nettoyage**, **475/69/61** occurrences `move`/`consume`/destructeur ;
- **35/40 modules** importés directement par au moins une fixture ou un test, soit **248 couples module-fichier de test** ;
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | ---: | ---: | --- | ---: | --- |
| `std.array` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 39 | 891 | 39 | 22/2/3 | 2/6/15 | 14 | 54 | `std.error`, `std.iterator`, `std.option`, `std.ordering`, `std.result` | 68 | `docs/language-guide.md` |
| `std.array_builder` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 9 | 153 | 9 | 15/0/1 | 4/3/2 | 6 | 10 | `std.array`, `std.builder`, `std.iterator`, `std.option`, `std.result` | 6 | `docs/language-guide.md`, `docs/design/iterator-pipelines.md` |
...
| `std.hashmap` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) | 30 | 913 | 34 | 40/5/3 | 3/25/2 | 16 | 26 | `std.array`, `std.builder`, `std.error`, `std.hash_probe`, `std.hashing`, `std.iterator`, `std.option`, `std.result` | 8 | `docs/language-guide.md`, `docs/stability-contract.md` |
| `std.hashset` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) | 22 | 627 | 26 | 18/2/3 | 3/10/2 | 10 | 18 | `std.array`, `std.builder`, `std.error`, `std.hash_probe`, `std.hashing`, `std.iterator`, `std.option`, `std.result` | 7 | `docs/language-guide.md`, `docs/stability-contract.md` |
...
| `std.iterator` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 37 | 952 | 37 | 85/23/14 | 4/53/2 | 29 | 93 | `std.builder`, `std.option`, `std.result` | 7 | `docs/language-guide.md`, `docs/design/iterator-pipelines.md`, `docs/stability-contract.md` |
| `std.math` | `stable-proposed` | `conservation` | [#113 / R074-4](https://github.com/cyril103/janus/issues/113) | 104 | 546 | 104 | 0/0/0 | 0/0/1 | 1 | 0 | `std.array` | 7 | `docs/language-guide.md`, `docs/stability-contract.md` |
...
| `std.option` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 23 | 566 | 45 | 61/12/2 | 0/72/1 | 9 | 39 | — | 23 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/option-result-combinators.md`, `docs/stability-contract.md` |
...
| `std.persistent_list` | `experimental` | `conservation` | [#300](https://github.com/cyril103/janus/issues/300) | 18 | 391 | 18 | 37/0/4 | 0/14/1 | 13 | 49 | `std.array`, `std.iterator`, `std.option`, `std.shared` | 3 | `docs/stdlib-reference.md`, `docs/design/persistent-list.md` |
...
| `std.validated` | `experimental` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 20 | 476 | 31 | 59/7/1 | 3/7/2 | 13 | 31 | `std.array`, `std.iterator`, `std.option`, `std.result` | 3 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/validated.md` |
