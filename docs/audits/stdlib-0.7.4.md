...
- **45 modules**, **18268 lignes** et **1264 symboles publics** inventoriés ;
- **1471 blocs `///` publics pour 1264 symboles** (couverture source du lot #115 : 100 %) ;
- **384 sites d'allocation**, **1043 marqueurs de nettoyage**, **1265/101/74** occurrences `move`/`consume`/destructeur ;
- **40/45 modules** importés directement par au moins une fixture ou un test, soit **315 couples module-fichier de test** ;
...
| `std.hashing` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) | 21 | 161 | 21 | 0/0/0 | 0/0/0 | 1 | 0 | — | 10 | `docs/language-guide.md`, `docs/stability-contract.md` |
| `std.hashmap` | `stable-proposed` | `conservation` | [#112 / R074-3](https://github.com/cyril103/janus/issues/112) | 30 | 905 | 34 | 41/9/3 | 3/25/2 | 16 | 26 | `std.array`, `std.builder`, `std.error`, `std.hash_probe`, `std.hashing`, `std.iterator`, `std.option`, `std.result` | 10 | `docs/language-guide.md`, `docs/stability-contract.md` |
...
| `std.option` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 23 | 571 | 45 | 61/12/2 | 0/72/1 | 9 | 39 | — | 32 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/option-result-combinators.md`, `docs/stability-contract.md` |
...
| `std.hashing` | `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/derived_capabilities.janus`, `tests/fixtures/runtime/hash_table_invariants.janus`, `tests/fixtures/runtime/hashing_borrow_error.janus`, `tests/fixtures/runtime/owned_hash_collections.janus`, `tests/fixtures/runtime/owned_hash_copy_error.janus`, `tests/fixtures/runtime/owned_hash_move_error.janus`, `tests/fixtures/runtime/owned_hash_panic.janus`, `tests/fixtures/runtime/owned_iterators.janus` |
| `std.hashmap` | `tests/fixtures/runtime/capacity_errors.janus`, `tests/fixtures/runtime/collection_enrichment.janus`, `tests/fixtures/runtime/derived_capabilities.janus`, `tests/fixtures/runtime/hash_table_invariants.janus`, `tests/fixtures/runtime/owned_hash_collections.janus`, `tests/fixtures/runtime/owned_hash_copy_error.janus`, `tests/fixtures/runtime/owned_hash_panic.janus`, `tests/fixtures/runtime/owned_iterators.janus`, `tests/fixtures/runtime/persistent_map.janus`, `tests/fixtures/runtime/persistent_map_allocation_panic.janus` |
