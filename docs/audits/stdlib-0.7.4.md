...
- **42 modules**, **17277 lignes** et **1209 symboles publics** inventoriés ;
- **1416 blocs `///` publics pour 1209 symboles** (couverture source du lot #115 : 100 %) ;
- **308 sites d'allocation**, **848 marqueurs de nettoyage**, **1187/96/62** occurrences `move`/`consume`/destructeur ;
- **37/42 modules** importés directement par au moins une fixture ou un test, soit **274 couples module-fichier de test** ;
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | ---: | ---: | --- | ---: | --- |
| `std.array` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 39 | 893 | 40 | 26/4/3 | 2/6/15 | 14 | 54 | `std.error`, `std.index`, `std.iterator`, `std.option`, `std.ordering`, `std.result` | 73 | `docs/language-guide.md` |
| `std.array_builder` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 9 | 153 | 9 | 16/0/1 | 4/3/2 | 6 | 10 | `std.array`, `std.builder`, `std.iterator`, `std.option`, `std.result` | 6 | `docs/language-guide.md`, `docs/design/iterator-pipelines.md` |
...
| `std.iterator` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 37 | 927 | 37 | 89/35/14 | 4/53/2 | 29 | 92 | `std.builder`, `std.option`, `std.result` | 10 | `docs/language-guide.md`, `docs/design/iterator-pipelines.md`, `docs/stability-contract.md` |
...
| `std.option` | `stable-proposed` | `conservation` | [#111 / R074-2](https://github.com/cyril103/janus/issues/111) | 23 | 571 | 45 | 61/12/2 | 0/72/1 | 9 | 39 | — | 29 | `docs/language-guide.md`, `docs/stdlib-reference.md`, `docs/design/option-result-combinators.md`, `docs/stability-contract.md` |
...
| `return match move value {` | `std.array_builder`, `std.iterator`, `std.option`, `std.persistent_list`, `std.result`, `std.validated` | 33 |
...
| `borrow data : Ptr[byte],` | `std.bytes`, `std.fs`, `std.io`, `std.process`, `std.system` | 10 |
