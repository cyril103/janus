...
| `borrow def capacity() : usize {` | `std.array`, `std.deque`, `std.hashmap`, `std.hashset`, `std.io` | 5 |
| `private var length : usize = usize(0)` | `std.array`, `std.deque`, `std.hashmap`, `std.hashset`, `std.text` | 5 |
