...
| `docs/language-guide.md` | 1225:16 | constructeur | `new Factory[int](` | pédagogique explicite | pédagogique explicite |
| `docs/language-guide.md` | 1584:43 | cast littéral | `usize(1)` | test de couverture | nécessaire (opérande binaire usize) |
