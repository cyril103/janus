...
| `docs/language-guide.md` | 1129:16 | constructeur | `new Factory[int](` | pédagogique explicite | pédagogique explicite |
| `docs/language-guide.md` | 1488:43 | cast littéral | `usize(1)` | test de couverture | nécessaire (opérande binaire usize) |
