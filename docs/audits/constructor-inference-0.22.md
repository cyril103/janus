...
| `docs/audits/stdlib-0.7.4.md` | 152:20 | cast littéral | `usize(1)` | test de couverture | donnée d’audit historique |
| `docs/audits/stdlib-0.7.4.md` | 153:24 | cast littéral | `usize(0)` | test de couverture | donnée d’audit historique |
...
| `docs/language-guide.md` | 1120:16 | constructeur | `new Factory[int](` | pédagogique explicite | pédagogique explicite |
| `docs/language-guide.md` | 1479:43 | cast littéral | `usize(1)` | test de couverture | nécessaire (opérande binaire usize) |
| `docs/stdlib-reference.md` | 37:41 | cast littéral | `usize(2)` | test de couverture | nécessaire (opérande binaire usize) |
| `docs/stdlib-reference.md` | 304:44 | cast littéral | `usize(8)` | test de couverture | nécessaire (opérande binaire usize) |
| `docs/stdlib-reference.md` | 449:55 | cast littéral | `usize(5)` | test de couverture | nécessaire (opérande binaire usize) |
| `docs/stdlib-reference.md` | 476:49 | cast littéral | `usize(2)` | test de couverture | nécessaire (opérande binaire usize) |
| `docs/stdlib-reference.md` | 604:45 | cast littéral | `usize(6)` | test de couverture | nécessaire (opérande binaire usize) |
| `docs/stdlib-reference.md` | 616:32 | cast littéral | `usize(6)` | test de couverture | nécessaire (opérande binaire usize) |
