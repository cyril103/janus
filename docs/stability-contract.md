...
L'[inventaire courant](stability-inventory-current.md) classe chaque surface
...
résultats, erreurs et cas limites suivent la
[matrice normative](numeric-conversions.md), indépendamment de la plateforme.
