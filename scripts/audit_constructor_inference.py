...
CONSTRUCTOR_EXCEPTIONS = {
    ...
    ("docs/language-guide.md", "new Factory[int](", 1056, 16): "pédagogique explicite",
...
CAST_EXCEPTIONS: dict[tuple[str, str, int, int], str] = {
    ...
    ("docs/audits/stdlib-0.7.4.md", "usize(1)", 148, 20): "donnée d’audit historique",
    ("docs/audits/stdlib-0.7.4.md", "usize(0)", 149, 24): "donnée d’audit historique",
    ...
    ("docs/language-guide.md", "usize(1)", 1415, 43): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(2)", 37, 41): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(8)", 265, 44): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(5)", 410, 55): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(2)", 437, 49): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 565, 45): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 577, 32): "nécessaire (opérande binaire usize)",
