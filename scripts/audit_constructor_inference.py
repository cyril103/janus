...
CONSTRUCTOR_EXCEPTIONS = {
    ...
    ("docs/language-guide.md", "new Factory[int](", 1120, 16): "pédagogique explicite",
...
CAST_EXCEPTIONS: dict[tuple[str, str, int, int], str] = {
    ...
    ("docs/audits/stdlib-0.7.4.md", "usize(1)", 154, 20): "donnée d’audit historique",
    ("docs/audits/stdlib-0.7.4.md", "usize(0)", 156, 24): "donnée d’audit historique",
    ...
    ("docs/language-guide.md", "usize(1)", 1479, 43): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(2)", 37, 41): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(8)", 328, 44): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(5)", 473, 55): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(2)", 500, 49): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 628, 45): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 640, 32): "nécessaire (opérande binaire usize)",
    ("stdlib/std/random.janus", "usize(1)", 8, 44): "nécessaire (opérande binaire usize)",
    ("website/docs/book/06-collections-iterateurs.md", "usize(5)", 106, 28): "nécessaire (opérande binaire usize)",
    ("website/docs/book/06-collections-iterateurs.md", "usize(1)", 113, 32): "nécessaire (opérande binaire usize)",
    ("website/docs/book/06-collections-iterateurs.md", "usize(3)", 113, 60): "nécessaire (opérande binaire usize)",
