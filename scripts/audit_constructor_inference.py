...
CONSTRUCTOR_EXCEPTIONS = {
    ...
    ("docs/language-guide.md", "new Factory[int](", 1077, 16): "pédagogique explicite",
...
CAST_EXCEPTIONS: dict[tuple[str, str, int, int], str] = {
    ...
    ("docs/audits/stdlib-0.7.4.md", "usize(1)", 150, 20): "donnée d’audit historique",
    ("docs/audits/stdlib-0.7.4.md", "usize(0)", 151, 24): "donnée d’audit historique",
    ...
    ("docs/language-guide.md", "usize(1)", 1436, 43): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(2)", 37, 41): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(8)", 284, 44): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(5)", 429, 55): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(2)", 456, 49): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 584, 45): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 596, 32): "nécessaire (opérande binaire usize)",
