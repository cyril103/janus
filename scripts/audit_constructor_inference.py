...
CONSTRUCTOR_EXCEPTIONS = {
    ...
    ("docs/language-guide.md", "new Factory[int](", 962, 16): "pédagogique explicite",
...
CAST_EXCEPTIONS: dict[tuple[str, str, int, int], str] = {
    ...
    ("docs/audits/stdlib-0.7.4.md", "usize(1)", 146, 20): "donnée d’audit historique",
    ("docs/audits/stdlib-0.7.4.md", "usize(0)", 147, 24): "donnée d’audit historique",
    ...
    ("docs/language-guide.md", "usize(1)", 1297, 43): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(2)", 37, 41): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(8)", 206, 44): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(5)", 351, 55): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(2)", 378, 49): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 506, 45): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 518, 32): "nécessaire (opérande binaire usize)",
