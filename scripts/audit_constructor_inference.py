...
CONSTRUCTOR_EXCEPTIONS = {
    ...
    ("docs/language-guide.md", "new Factory[int](", 1216, 16): "pédagogique explicite",
...
CAST_EXCEPTIONS: dict[tuple[str, str, int, int], str] = {
    ...
    ("docs/language-guide.md", "usize(1)", 1575, 43): "nécessaire (opérande binaire usize)",
    ...
    ("docs/stdlib-reference.md", "usize(2)", 506, 49): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 634, 45): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 646, 32): "nécessaire (opérande binaire usize)",
