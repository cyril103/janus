...
CAST_EXCEPTIONS: dict[tuple[str, str, int, int], str] = {
    ...
    ("docs/stdlib-reference.md", "usize(8)", 378, 44): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(5)", 523, 55): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(2)", 550, 49): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 678, 45): "nécessaire (opérande binaire usize)",
    ("docs/stdlib-reference.md", "usize(6)", 690, 32): "nécessaire (opérande binaire usize)",
    ...
    ("website/docs/book/02-valeurs-types.md", "usize(1)", 122, 41): "pédagogique (arithmétique usize)",
