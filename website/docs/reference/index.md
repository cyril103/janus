...
!!! warning "Version expérimentale"
    Cette référence décrit **Janus 0.5.0**. Avant la version 1.0, la syntaxe, la bibliothèque standard et le format des paquets peuvent évoluer sans compatibilité ascendante.
