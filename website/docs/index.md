...
<div class="home-shell">
  <section class="home-hero">
    <div class="eyebrow">JANUS / VERSION 0.10.0 / PRÉ-1.0</div>
...
=== "Linux"
    ...
    curl --proto '=https' --tlsv1.2 -fsSL \
      https://raw.githubusercontent.com/cyril103/janus/v0.10.0/scripts/install.sh | sh
...
=== "Windows x86_64"
    ...
    ```powershell
    irm https://raw.githubusercontent.com/cyril103/janus/v0.10.0/scripts/install.ps1 | iex
    ```
...
La documentation canonique décrit précisément le langage 0.10.0, les outils, le texte et le graphisme.
...
**Ce que 0.10.0 apporte.** Janus ajoute les imports qualifiés, sélectifs et
renommés, l’inférence des variables locales, les constantes évaluées à la
compilation et un framework de tests natif avec rapports CI. Les conversions
numériques explicites, la découverte d’API et la chaîne d’installation sont
également renforcées. Cette version mineure reste explicitement pré-1.0.
[Lire le changelog](https://github.com/cyril103/janus/blob/v0.10.0/CHANGELOG.md),
