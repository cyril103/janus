...
<div class="home-shell">
  <section class="home-hero">
    <div class="eyebrow">JANUS / VERSION 0.23.0 / PRÉ-1.0</div>
...
=== "Linux"
    ...
    curl --proto '=https' --tlsv1.2 -fsSL \
      https://raw.githubusercontent.com/cyril103/janus/v0.23.0/scripts/install.sh | sh
...
=== "Windows x86_64"
    ...
    ```powershell
    irm https://raw.githubusercontent.com/cyril103/janus/v0.23.0/scripts/install.ps1 | iex
    ```
...
La documentation canonique décrit précisément le langage 0.23.0, les outils, le texte et le graphisme.
...
**Ce que 0.23.0 apporte.** Janus consolide son chemin vers 1.0 avec une session
de compilation partagée, des diagnostics entièrement classifiés, les migrations
de dépréciation et un LSP capable d'annuler les travaux obsolètes. Les gates de
release, les mesures de performance et la publication de l'extension deviennent
reproductibles. Cette version reste explicitement pré-1.0.
[Lire le changelog](https://github.com/cyril103/janus/blob/v0.23.0/CHANGELOG.md),
