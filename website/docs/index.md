...
<div class="home-shell">
  <section class="home-hero">
    <div class="eyebrow">JANUS / VERSION 0.25.0 / PRÉ-1.0</div>
...
=== "Linux"
    ...
    curl --proto '=https' --tlsv1.2 -fsSL \
      https://raw.githubusercontent.com/cyril103/janus/v0.25.0/scripts/install.sh | sh
...
=== "Windows x86_64"
    ...
    ```powershell
    irm https://raw.githubusercontent.com/cyril103/janus/v0.25.0/scripts/install.ps1 | iex
    ```
...
La documentation canonique décrit précisément le langage 0.25.0, les outils, le texte et le graphisme.
...
**Ce que 0.25.0 apporte.** Janus ajoute la construction nommée des structs,
les littéraux de maps et les ressources locales `using val`. Les collections
persistantes permettent de conserver des snapshots, tandis que la composition
de fonctions s’appuie sur les capacités explicites `Fn`, `FnMut` et `FnOnce`.
Les anciens types de callbacks doivent préciser leur capacité d’appel.
Cette version reste explicitement pré-1.0.
[Lire le changelog](https://github.com/cyril103/janus/blob/v0.25.0/CHANGELOG.md),
