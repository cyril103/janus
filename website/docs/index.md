...
<div class="home-shell">
  <section class="home-hero">
    <div class="eyebrow">JANUS / VERSION 0.15.0 / PRÉ-1.0</div>
...
=== "Linux"
    ...
    curl --proto '=https' --tlsv1.2 -fsSL \
      https://raw.githubusercontent.com/cyril103/janus/v0.15.0/scripts/install.sh | sh
...
=== "Windows x86_64"
    ...
    ```powershell
    irm https://raw.githubusercontent.com/cyril103/janus/v0.15.0/scripts/install.ps1 | iex
    ```
...
La documentation canonique décrit précisément le langage 0.15.0, les outils, le texte et le graphisme.
...
**Ce que 0.15.0 apporte.** Les processus enfants disposent maintenant de
lectures et écritures non bloquantes portables. L'analyseur empêche aussi la
libération d'un propriétaire tant qu'un alias local ou un champ `borrow` le
référence encore.
Cette version reste explicitement pré-1.0.
[Lire le changelog](https://github.com/cyril103/janus/blob/v0.15.0/CHANGELOG.md),
