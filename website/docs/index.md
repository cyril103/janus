...
<div class="home-shell">
  <section class="home-hero">
    <div class="eyebrow">JANUS / VERSION 0.7.6 / EXPÉRIMENTAL</div>
...
La documentation canonique décrit précisément le langage 0.7.6, les outils, le texte et le graphisme.
...
**Ce que 0.7.6 apporte.** La bibliothèque standard entière est auditée,
modernisée avec les contrats de propriété récents et documentée dans une
référence API déterministe. Cette version cumulative inclut aussi chemins,
fichiers, flux, processus, dérivations et doctests.
[Lire le changelog](https://github.com/cyril103/janus/blob/v0.7.6/CHANGELOG.md)
