...
<div class="home-shell">
  <section class="home-hero">
    <div class="eyebrow">JANUS / VERSION 0.12.0 / PRÉ-1.0</div>
...
=== "Linux"
    ...
    curl --proto '=https' --tlsv1.2 -fsSL \
      https://raw.githubusercontent.com/cyril103/janus/v0.12.0/scripts/install.sh | sh
...
=== "Windows x86_64"
    ...
    ```powershell
    irm https://raw.githubusercontent.com/cyril103/janus/v0.12.0/scripts/install.ps1 | iex
    ```
...
La documentation canonique décrit précisément le langage 0.12.0, les outils, le texte et le graphisme.
...
**Ce que 0.12.0 apporte.** `std.fs` sait supprimer récursivement une
arborescence et `std.testing` expose un nettoyage temporaire explicite. Janus
valide désormais LLVM 18 à 21. Le VSIX est produit et contrôlé par la CI, puis
remis au mainteneur pour une publication Marketplace exclusivement manuelle.
Cette version reste explicitement pré-1.0.
[Lire le changelog](https://github.com/cyril103/janus/blob/v0.12.0/CHANGELOG.md),
