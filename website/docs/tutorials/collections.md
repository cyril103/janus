...
- Janus 0.5.0, sans paquet additionnel.
...
Le code suivant est celui de l’exemple réel [`examples/iterator_pipeline.janus`](https://github.com/cyril103/janus/blob/v0.5.0/examples/iterator_pipeline.janus) :
