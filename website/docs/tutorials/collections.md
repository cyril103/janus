...
- Janus 0.7.6, sans paquet additionnel.
...
Le code suivant est celui de l’exemple réel [`examples/iterator_pipeline.janus`](https://github.com/cyril103/janus/blob/v0.7.6/examples/iterator_pipeline.janus) :
