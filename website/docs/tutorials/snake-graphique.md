...
À chaque image, il utilise les APIs 0.7.4 de temps et d’entrée :
...
Le [source complet v0.7.4](https://github.com/cyril103/janus/blob/v0.7.4/examples/snake/main.janus) reste l’autorité : ce tutoriel n’introduit aucune API graphique supplémentaire.
