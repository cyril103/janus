...
!!! success "Vous avez le socle"
    Vous savez maintenant lire et construire un programme Janus, gérer ses ressources, utiliser ses outils et retrouver un contrat précis dans la référence. Continuez avec les [tutoriels](../tutorials/index.md) ou explorez les [exemples du dépôt](https://github.com/cyril103/janus/tree/v0.8.1/examples).
